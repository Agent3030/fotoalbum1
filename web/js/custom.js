...
=================================== */
    ...
    $('#screenshots3 a').nivoLightbox({
        effect: 'fadeScale',
    });

    $('#screenshots4 a').nivoLightbox({
        effect: 'fadeScale',
    });

    $('#screenshots5 a').nivoLightbox({
        effect: 'fadeScale',
    });

    $('#screenshots6 a').nivoLightbox({
        effect: 'fadeScale',
    });
...
//code for calculator button
   /* $('#calc-button').on('click', function() {
        var url = "/calculator/default/index";
